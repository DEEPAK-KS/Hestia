import { FaStore, FaUser, FaBoxOpen, FaClipboardList, FaSignOutAlt } from 'react-icons/fa'
            ...
            <NavLink
                ...
                className={({ isActive }) =>
                    isActive
                        ...
                        : "hover:bg-gray-700 text-white px-3 py-4 rounded flex items-center space-x-2"
                }
            >
                <FaUser/>
                <span>Users</span>
